    ...
    <div className="">
      ...
      <section className="relative h-screen overflow-hidden pt-12 font-quicksand-bold">
        ...
        <div className="absolute top-[40%] right-0 left-0">
          ...
          >
            Ami&M xây dựng{" "}
            <span className="bg-gradient-to-r from-[#328ae2] to-[#ff0d39] bg-clip-text text-transparent">
      ...
      <section className="relative">
        ...
        <div className="pt-50">
          ...
          <p
            ...
            data-aos-delay="300"
          >
            <span className="block bg-gradient-to-r from-[#328ae2] to-[#ff0d39] bg-clip-text text-transparent">
